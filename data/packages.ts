...
export const ALL_PACKAGES: Package[] = [
  ...
  /* ─────────────────────────────────────────────────────────── */
  {
    ...
    variants: [
      ...
      {
        origin: "Haldwani (Kathgodam)",
        originSlug: "haldwani",
        duration: 5,
        nights: 4,
        price: 22999,
        priceNote: "Per person, from Haldwani (Kathgodam)",
        meals: "4 breakfasts · 4 dinners",
        itinerary: [
          {
            day: 1,
            title: "Haldwani → Pithoragarh (1,814 m)",
            description:
              "Scenic drive through the heart of the Kumaon Himalayas via Bhimtal, Bhowali, Kainchi Dham, Almora, and Chaukori to Pithoragarh. Panoramic mountain views, pine forests, terraced fields, and hand-picked viewpoint stops along the way. Check in, warm dinner, and overnight rest.",
          ...
          },
          {
            ...
            title: "Pithoragarh → Gunji / Nabi (3,380 m)",
            description:
              "Complete medical checkup and obtain necessary permits at Pithoragarh. Drive to Gunji / Nabi village through Chialekh meadows and Garbyang — keep government ID handy for permit checks. Warm dinner and overnight at a guesthouse / homestay.",
            accommodation: "Guesthouse / Homestay, Gunji / Nabi",
            altitude: 3380,
          },
          {
            ...
            title: "Gunji / Nabi → Adi Kailash (Jyolingkong) → Gunji",
            description:
              "Begin early for the soulful trek to Jyolingkong. Darshan at the sacred Parvati Sarovar Temple and Adi Kailash. Witness the tranquil beauty of Gauri Kund and offer prayers to Lord Shiva and Goddess Parvati. Trek back to Gunji, visit Manokamna Temple, overnight surrounded by the peace of the Himalayas.",
            accommodation: "Guesthouse / Homestay, Gunji / Nabi",
            altitude: 4378,
          },
          {
            ...
            title: "Gunji → Om Parvat → Kali Maa Temple → Pithoragarh",
            description:
              "Scenic drive through the high Himalayas to the Om Parvat viewpoint — natural ॐ snow formation. Mount Kailash darshan on clear days (weather + army permission permitting). Kali Maa Temple darshan. Return drive to Pithoragarh for overnight.",
            accommodation: "Hotel, Pithoragarh",
            altitude: 4266,
          },
          {
            day: 5,
            title: "Pithoragarh → Jageshwar Dham → Kainchi Dham → Haldwani",
            description:
              "Checkout and drive to Jageshwar Dham — a cluster of 124 ancient stone temples in a deodar valley. Sacred Shiva Lingam darshan. Visit Chitai Golu Devta Temple, then continue to the revered Kainchi Dham. Return drive to Haldwani.",
            altitude: 554,
          },
        ],
      },
      {
        ...
        nights: 4,
        price: 25999,
        priceNote: "Per person, from Delhi",
        meals: "4 breakfasts · 4 dinners",
        itinerary: [
          {
            day: 1,
            title: "Delhi → Pithoragarh (1,814 m)",
            description:
              "Depart Delhi via Tanakpur — the shorter, scenic route into the Kumaon Himalayas. Travel through mountain roads, dense forests, river valleys, and charming hill towns of Uttarakhand. Refreshing stops en route. Arrive Pithoragarh, check in, delicious dinner, and overnight rest before the pilgrimage begins.",
            accommodation: "Hotel, Pithoragarh",
            altitude: 1814,
          },
          {
          ...
          {
            day: 5,
            title: "Pithoragarh → Jageshwar Dham → Kainchi Dham → Delhi",
            description:
              "Checkout and drive to Jageshwar Dham — a cluster of 124 ancient stone temples in a deodar valley. Sacred Shiva Lingam darshan. Visit Chitai Golu Devta Temple, then continue to the revered Kainchi Dham. Onward drive back to Delhi via Tanakpur.",
            altitude: 220,
          },
        ],
      },
  ...
  /* ─────────────────────────────────────────────────────────── */
  {
    ...
    gallery: [
      ...
      "https://upload.wikimedia.org/wikipedia/commons/7/74/Panchachuli_Trek%2C_in_Darma_Valley.jpg",
